...
1. Using the same data from last week, would you able to get a summary of the average gene expression value from each patients? you might need to extract the name of the sample using the  
